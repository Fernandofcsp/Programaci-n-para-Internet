...
<html>
					...
					$.ajax({
						...
						success  : function(resultband) {
							if (resultband==1){  //bandera
								...
								$('#mensaje').html('Producto eliminado').show(); //Permite que se vuelva a mostrar despues de ser ocultado
	...
	<?php include("Menu.php"); ?>
        ...
        <div class=contenedor-fila height="50" align="center">
			<div class=contenedor-cabecera colspan="6" style="font-size: 25px">Lista de Productos</div>
		</div>
		<div style="background-color:#E3E4E5; vertical-align:middle;height:20px;">
			<div ><a href="productos_nuevo.php">Agregar Producto</a></div>
		</div>
		...
		<div class=contenedor-fila id="filacampos" height="200" align="center" valign="middle">
            ...
            <div class=contenedor-correo >Codigo</div>
            <div class=contenedor-rol >Costo</div>
			<div class=contenedor-stock >Stock</div>
        ...
        echo "<div class=contenedor-columna width=\"33.33%\">$codigo</div>";
        echo "<div class=contenedor-roldatos width=\"33.33%\">$costo</div>";
		echo "<div class=contenedor-stocknumeros width=\"33.33%\">$stock</div>";
		echo "<div class=contenedor-botondatos width=\"50%\"><input type=\"button\" style=\"background-color:#00ffff;border-color:black;padding:3px;\" id =\"vdet\" value=\"Ver detalle\" onclick = \"location='productos_detalle.php?id=$id'\" ></div>";
		echo "<div class=contenedor-botondatos width=\"50%\"><input type=\"button\" style=\"background-color:#FFFFFF;border-color:black;padding:3px;\" id =\"vedit\" value=\"Editar\" onclick = \"location='productos_edita.php?id=$id'\" ></div>";
